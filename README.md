...
- **CSS3:** Robust styling leveraging modern browser capabilities for responsive alignment.

## 📁 File Structure
```text
├── hero.html                    # Main landing page structure
├── README.md                    # Project documentation
├── japwave.jpg                  # High quality background/hero asset
├── prosurf.jpg                  # Image asset
├── surf2.jpg                    # Image asset
└── surf.avif                    # Optimized image asset
```
...
1. Clone the repo
   ```sh
   git clone https://github.com/paarshviv12/SURFING.git
   ```
2. Open `hero.html` in your web browser.
